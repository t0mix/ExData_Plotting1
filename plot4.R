...
plot4topng <- function(data) {
        ...
        plot(data[,10],data[,3], xlab = "", ylab = "Global Active Power", col = "black", type="l")
        
        plot(data[,10],data[,5], xlab = "datetime", ylab = "Voltage", col = "black", type="l")
        ...
        plot(data[,10],data[,4], xlab = "datetime", ylab = "Global_reactive_power", col = "black", type="l")
